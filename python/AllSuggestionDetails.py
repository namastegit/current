...
def main():
    video_ids = ["7EVlx7mpZ4M", "MLagf3_APuY", "-fzkzVyzdkk", "kdmtp6iJnRk", "vmsrQymzjRo"]
    ...
    if all_video_info:
        ...
        with open("suggested_videos_info.json", "w") as json_file:
            json.dump(all_video_info, json_file, indent=4)

        print("Suggested videos info saved to suggested_videos_info.json")
    else:
