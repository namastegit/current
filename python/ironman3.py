    ...
    for video_id in video_ids:
        ...
        while True:
            ...
            for item in response['items']:
                ...
                # Check if the comment meets the word count requirement
                if len(comment_text.split()) >= 6:
                    # Check if replies exist for the comment
                    if 'replies' in item['snippet']:
                        replies_data = item['replies']['comments']
                        # Fetch all replies for each comment
                        replies = [reply['snippet']['textDisplay'] for reply in replies_data]
                    else:
                        replies = []
        ...
        # Fetch video details for the current video
...
def write_csv(all_comments):
    ...
    with open(file_name, "w", newline='', encoding='utf-8') as csv_file:
        ...
        for video_id, data in all_comments.items():
            ...
            total_comments, comments = comments_info
