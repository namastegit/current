...
def main():
    video_urls = ["https://www.youtube.com/watch?v=WoDQaSx7ifI", "https://www.youtube.com/watch?v=B1F1eRETQv4", "https://www.youtube.com/watch?v=RY2DrUt73ds", "https://www.youtube.com/watch?v=XxGN_cWH6PM", "https://www.youtube.com/watch?v=symKodeZUnk"]
    ...
    for video_url in video_urls:
        ...
        if video_id:
            ...
            if video_details:
                ...
                write_csv(video_details, total_comments, comments, video_id)

                print(f"Video info and comments for video ID {video_id} saved to CSV files.")
            else:
                print("Unable to fetch video details.")
        else:
            print("Invalid YouTube video URL.")

def write_csv(video_details, total_comments, comments, video_id):
    word_count = 0
    file_number = 1
    file_name = f"video_info_{video_id}_{file_number}.csv"
